...
# Find Skills (via skills.sh ecosystem)
...
Check https://skills.sh/ for well-known skills. Top sources include:
...
Show the user: skill name, description, install count, source, and install command.
...
3. Check popular sources: `vercel-labs/agent-skills` or `ComposioHQ/awesome-claude-skills`
